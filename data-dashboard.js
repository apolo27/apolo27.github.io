function toogleToScreen(toogle){
    if (toogle=="tripulants"){
        let b1 = document.querySelector(".b1 button");
        let b2 = document.querySelector(".b2 button");
        b1.style.backgroundColor = "var(--lightOne)";
        b2.style.backgroundColor = "var(--mainColor)";
        $("#body-1").hide();
        $("#body-2").show();
    }
    else{
        let b1 = document.querySelector(".b1 button");
        let b2 = document.querySelector(".b2 button");
        b2.style.backgroundColor = "var(--lightOne)";
        b1.style.backgroundColor = "var(--mainColor)";
        $("#body-1").show();
        $("#body-2").hide();
    }
}
